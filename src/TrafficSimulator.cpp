...
{
  //Assigns filename of corresponding city map
  ...
  //Positions intersections in pixel coordinates (counter-clockwise)
  ...
  //Creates streets and connect traffic objects
  int nStreets = 8;
...
void createTrafficObjects_NYC(std::vector<std::shared_ptr<Street>> &streets, std::vector<std::shared_ptr<Intersection>> &intersections, std::vector<std::shared_ptr<Vehicle>> &vehicles, std::string &filename, int nVehicles)
{
  ...
  //Positions intersections in pixel coordinates
...
int main()
{
  ...
  //Creates and connect intersections and streets
  std::vector<std::shared_ptr<Street>> streets;
  std::vector<std::shared_ptr<Intersection>> intersections;
  std::vector<std::shared_ptr<Vehicle>> vehicles;
  std::string backgroundImg;

  //Vary the number of simulated vehicles
  int nVehicles = 6;
